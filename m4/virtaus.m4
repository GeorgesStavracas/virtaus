...
AC_DEFUN([VIRTAUS_ADD_STAMP],
[
    virtaus_stamp_files="$virtaus_stamp_files $srcdir/$1"
])

# _VIRTAUS_ADD_PLUGIN_INTERNAL(NAME-OF-PLUGIN,
...
# conditional
AC_DEFUN([_VIRTAUS_ADD_PLUGIN_INTERNAL],
[
    ...
    VIRTAUS_ADD_STAMP([plugins/$1/libvirtaus_$2_la_vala.stamp])
    echo "$1: plugins/$1/libvirtaus_$2_la_vala.stamp"
...
# Add an --enable-plugin option, add its Makefile to AC_OUTPUT and set the
# conditional
AC_DEFUN([VIRTAUS_ADD_PLUGIN],
[
    echo "PLUGIN: plugin \"$2\" enabled"
    _VIRTAUS_ADD_PLUGIN_INTERNAL([$1],
        m4_translit([$1],[-],[_]),
        [$2],
        [$3])
])
